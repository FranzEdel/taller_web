...
function addCadreTVAs($totalLetras)
{
    ...
    $this->SetXY( $r1+35, $y1);
    $this->Cell(10,4, "-- IMPORTE TOTAL A CANCELAR --");
    $this->SetX( $r1+29 );
    ...
    $this->SetFont( "Arial", "B", 10);
    $this->SetXY( $r1+3, $y2 - 8 );
    $this->Cell(6,0, $totalLetras);
    /* $this->SetXY( $r1+93, $y2 - 3 );
    $this->Cell(6,0, "T.V.A. :"); */
}

function addCadreEurosFrancs($total,$iva)
{
    $r1  = $this->w - 70;
    $r2  = $r1 + 60;
    $y1  = $this->h - 40;
    ...
    $this->Cell(20,4, "--  Bs/ ".number_format($total*0.87,2,".",","), 0, 0, "R");
    $this->SetXY( $r1+40, $y1+10 );
    $this->Cell(20,4, "--  Bs/ ".number_format($total*$iva,2,".",","), 0, 0, "R");
    $this->SetXY( $r1+40, $y1+15 );
    $this->Cell(20,4, "--  Bs/ ".number_format($total*0.87+$total*$iva,2,".",","), 0, 0, "R");
}
